if Config.Banking ~= 'snipe-banking' then return end
...
function RemoveMoneyFromSociety(society, price, playerIdentifier)
    ...
    local money = exports['snipe-banking']:GetAccountBalance(society)
    if money < price then return false end

    local removed = exports['snipe-banking']:RemoveMoneyFromAccount(society, price)
    return removed
end
