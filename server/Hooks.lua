-- Originally taken from qbx_core, credits goes to them for modification and credits for original code to overextended
-- Link: https://github.com/Qbox-project/qbx_core/blob/main/modules/hooks.lua
